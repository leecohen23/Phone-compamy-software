...
class Call:
    ...
    #     """
    #     Returns the duration of a call.
    #     """
    #     return self.duration

    # def get_srcloc(self) -> Tuple[float, float]:
    #     """
    #     return the source location of the call.
    #     """
    #     return self.src_loc

    # def get_dstloc(self) -> Tuple[float, float]:
    #     """
    #     Returns the destination location of the call.
    #     """
    #     return self.dst_loc
